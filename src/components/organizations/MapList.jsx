  ...
  >
      ...
      <table>
        ...
        <tbody>
          {maps.map((map) => (
            <tr
              key={map.id}
              style={{ backgroundColor: map.highlighted ? 'gray' : 'transparent' }}
    ...
    {showUpdateForm && (
      <div className="popup-form">
        ...
        <label>Name:</label>
        <input type="text" name="mapName" value={formData.mapName} onChange={handleInputChange} />
        <button onClick={() => handleUpdateMap(selectedMapId)}>Update Map</button>
        <button onClick={handleCloseForms}>Close</button>
      </div>
    )}
    ...
    {showDeleteForm && (
      <div className="popup-form">
        ...
        <button onClick={() => handleDeleteMap(selectedMapId)}>Delete Map</button>
