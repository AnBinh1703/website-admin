...
const RoundList = () => {
 ...
 const handleFetchRoundById = (id) => {
  const updatedRounds = rounds.map((round) =>
    round.id === id ? { ...round, highlighted: !round.highlighted } : { ...round, highlighted: false }
  );
    ...
    <div id="round-list-container">
      ...
      <div>
        ...
        <button
          ...
          onClick={() => selectedRoundId && handleShowUpdateForm(selectedRoundId)}
        ...
        <button
          ...
          onClick={() => selectedRoundId && handleShowDeleteForm(selectedRoundId)}
          disabled={!selectedRoundId}
        >
          Delete Round
        </button>
        ...
        <table>
          ...
          <tbody>
            {rounds.map((round) => (
              <tr
                key={round.id}
    style={{ backgroundColor: round.highlighted ? 'gray' : 'transparent' }}
  ...
  <div className="popup-form">
    ...
    <input type="text" name="roundName" value={formData.roundName} onChange={handleInputChange} />
...
{showUpdateForm && (
  <div className="popup-form">
    ...
    <label>Round Name:</label>
    <input type="text" name="roundName" value={formData.roundName} onChange={handleInputChange} />
    <button onClick={() => handleUpdateRound(selectedRoundId)}>Update Round</button>
    <button onClick={handleCloseForms}>Close</button>
  </div>
)}
...
{showDeleteForm && (
  <div className="popup-form">
    ...
    <button onClick={() => handleDeleteRound(selectedRoundId)}>Delete Round</button>
